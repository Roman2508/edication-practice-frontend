...
export type DeleteAllStudentsByIdsMutation = { readonly __typename?: 'Mutation', readonly deleteStudent: { readonly __typename?: 'StudentEntityResponse', readonly data: { readonly __typename?: 'StudentEntity', readonly id: string } } };
...
export type DeleteSelectedBasesOfPracticeByIdsMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type DeleteSelectedBasesOfPracticeByIdsMutation = { readonly __typename?: 'Mutation', readonly deleteSelectedBasesOfPractice: { readonly __typename?: 'SelectedBasesOfPracticeEntityResponse', readonly data: { readonly __typename?: 'SelectedBasesOfPracticeEntity', readonly id: string } } };
...
export type GetSelectedBasesOfPracticeByIdsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSelectedBasesOfPracticeByIdsQuery = { readonly __typename?: 'Query', readonly selectedBasesOfPractices: { readonly __typename?: 'SelectedBasesOfPracticeEntityResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'SelectedBasesOfPracticeEntity', readonly id: string }> } };
...
export type GetAllStudentsIdsQuery = { readonly __typename?: 'Query', readonly students: { readonly __typename?: 'StudentEntityResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'StudentEntity', readonly id: string }> } };
...
export type GetSelectedPracticeCountByIdQuery = { readonly __typename?: 'Query', readonly selectedBasesOfPractices: { readonly __typename?: 'SelectedBasesOfPracticeEntityResponseCollection', readonly data: ReadonlyArray<{ readonly __typename?: 'SelectedBasesOfPracticeEntity', readonly attributes: { readonly __typename?: 'SelectedBasesOfPractice', readonly pharmacy: { readonly __typename?: 'PharmacyEntityResponse', readonly data: { readonly __typename?: 'PharmacyEntity', readonly id: string } } } }> } };
...
export const DeletePharmacyDocument = gql`
  ...
  deletePharmacy(id: $id) {
    ...
    `;
export const DeleteSelectedBasesOfPracticeByIdsDocument = gql`
    mutation DeleteSelectedBasesOfPracticeByIds($id: ID!) {
  deleteSelectedBasesOfPractice(id: $id) {
    data {
      id
    }
  }
...
export const GetAllGroupsDocument = gql`
    query GetAllGroups {
  groups(pagination: {pageSize: 100}) {
    data {
      id
      attributes {
        name
...
export const GetAllPharmacyIdsDocument = gql`
  ...
  pharmacies(pagination: {pageSize: 10000}) {
    ...
    `;
export const GetSelectedBasesOfPracticeByIdsDocument = gql`
    query GetSelectedBasesOfPracticeByIds {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    DeleteAllStudentsByIds(variables: DeleteAllStudentsByIdsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteAllStudentsByIdsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteAllStudentsByIdsMutation>(DeleteAllStudentsByIdsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteAllStudentsByIds', 'mutation');
    },
    ...
    DeleteSelectedBasesOfPracticeByIds(variables: DeleteSelectedBasesOfPracticeByIdsMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteSelectedBasesOfPracticeByIdsMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteSelectedBasesOfPracticeByIdsMutation>(DeleteSelectedBasesOfPracticeByIdsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteSelectedBasesOfPracticeByIds', 'mutation');
    },
    ...
    GetSelectedBasesOfPracticeByIds(variables?: GetSelectedBasesOfPracticeByIdsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSelectedBasesOfPracticeByIdsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSelectedBasesOfPracticeByIdsQuery>(GetSelectedBasesOfPracticeByIdsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSelectedBasesOfPracticeByIds', 'query');
    },
    ...
    GetAllStudentsIds(variables?: GetAllStudentsIdsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAllStudentsIdsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAllStudentsIdsQuery>(GetAllStudentsIdsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAllStudentsIds', 'query');
    },
    ...
    GetSelectedPracticeCountById(variables: GetSelectedPracticeCountByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSelectedPracticeCountByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSelectedPracticeCountByIdQuery>(GetSelectedPracticeCountByIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSelectedPracticeCountById', 'query');
    },
