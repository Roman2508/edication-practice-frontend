...
export type ChangePlacesCountInPharmacyMutation = {
  readonly __typename?: 'Mutation'
  readonly updatePharmacy: {
    readonly __typename?: 'PharmacyEntityResponse'
    readonly data: {
      readonly __typename?: 'PharmacyEntity'
      readonly id: string
      readonly attributes: { readonly __typename?: 'Pharmacy'; readonly places: number }
    }
  }
}
...
export type ChangeStudentDataMutation = {
  readonly __typename?: 'Mutation'
...
export type DeletePharmacyMutation = {
  readonly __typename?: 'Mutation'
  readonly deletePharmacy: {
    readonly __typename?: 'PharmacyEntityResponse'
    readonly data: { readonly __typename?: 'PharmacyEntity'; readonly id: string }
  }
}
...
export type SelectBaseOfPracticeMutation = {
  readonly __typename?: 'Mutation'
  readonly createSelectedBasesOfPractice: {
    readonly __typename?: 'SelectedBasesOfPracticeEntityResponse'
    readonly data: {
      readonly __typename?: 'SelectedBasesOfPracticeEntity'
      readonly id: string
...
export type UpdateSettingsMutation = {
  ...
  readonly updateSetting: {
    ...
    readonly data: {
      ...
      readonly attributes: {
        readonly __typename?: 'Setting'
        readonly startPracticeDate: any
        readonly endPracticeDate: any
        readonly canStudentSelectPracticeBase: boolean
        readonly practiceTypes: {
          readonly __typename?: 'PracticeTypeRelationResponseCollection'
          readonly data: ReadonlyArray<{
            readonly __typename?: 'PracticeTypeEntity'
            readonly id: string
            readonly attributes: { readonly __typename?: 'PracticeType'; readonly name: string }
          }>
        }
        readonly currentPracticeType: {
          readonly __typename?: 'PracticeTypeEntityResponse'
          readonly data: {
            readonly __typename?: 'PracticeTypeEntity'
            readonly id: string
...
export type CanUserChoosePracticeBaseQuery = {
  readonly __typename?: 'Query'
...
export type GetAllPharmaciesQuery = {
  readonly __typename?: 'Query'
  readonly pharmacies: {
    readonly __typename?: 'PharmacyEntityResponseCollection'
    readonly meta: {
...
export type GetAllPharmacyIdsQuery = {
  readonly __typename?: 'Query'
  readonly pharmacies: {
    readonly __typename?: 'PharmacyEntityResponseCollection'
    readonly data: ReadonlyArray<{ readonly __typename?: 'PharmacyEntity'; readonly id: string }>
  }
}
...
export type GetAllSelectedPracticeBaseQuery = {
  readonly __typename?: 'Query'
  readonly selectedBasesOfPractices: {
    readonly __typename?: 'SelectedBasesOfPracticeEntityResponseCollection'
    readonly meta: {
        ...
        readonly pharmacy: {
          ...
          readonly data: {
            ...
            readonly attributes: {
              ...
              readonly legalName: string
              readonly contractNumber: string
              readonly headOfPractice: string
            }
          }
        }
      }
...
export type GetCanStudentsSelectPracticeBaseQuery = {
  readonly __typename?: 'Query'
  readonly setting: {
    readonly __typename?: 'SettingEntityResponse'
    readonly data: {
      readonly __typename?: 'SettingEntity'
      readonly attributes: { readonly __typename?: 'Setting'; readonly canStudentSelectPracticeBase: boolean }
    }
  }
}
...
export type GetFullPharmacyQuery = {
  readonly __typename?: 'Query'
  readonly pharmacies: {
    readonly __typename?: 'PharmacyEntityResponseCollection'
    readonly data: ReadonlyArray<{
...
export type GetSearchPharmaciesQuery = {
  readonly __typename?: 'Query'
  readonly pharmacies: {
    readonly __typename?: 'PharmacyEntityResponseCollection'
    readonly data: ReadonlyArray<{
...
export type GetSelectedPracticeCountByIdQueryVariables = Exact<{
  pharmacyId: Scalars['ID']['input']
}>

export type GetSelectedPracticeCountByIdQuery = {
  readonly __typename?: 'Query'
  readonly selectedBasesOfPractices: {
    readonly __typename?: 'SelectedBasesOfPracticeEntityResponseCollection'
    readonly data: ReadonlyArray<{
...
export const GetAllPharmaciesDocument = gql`
  query GetAllPharmacies($currentPage: Int = 1, $pageSize: Int = 10) {
    pharmacies(pagination: { page: $currentPage, pageSize: $pageSize }, filters: { places: { notIn: 0 } }) {
      meta {
        pagination {
          total
          page
...
`
export const GetSelectedPracticeCountByIdDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    changePlacesCountInPharmacy(
      variables: ChangePlacesCountInPharmacyMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ChangePlacesCountInPharmacyMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ChangePlacesCountInPharmacyMutation>(ChangePlacesCountInPharmacyDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'changePlacesCountInPharmacy',
    ...
    ChangeStudentData(
      variables: ChangeStudentDataMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ChangeStudentDataMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ChangeStudentDataMutation>(ChangeStudentDataDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'ChangeStudentData',
    ...
    CreateStudent(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateStudentMutation>(CreateStudentDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'CreateStudent',
    ...
    DeletePharmacy(
      variables: DeletePharmacyMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<DeletePharmacyMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DeletePharmacyMutation>(DeletePharmacyDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'DeletePharmacy',
    ...
    selectBaseOfPractice(
      variables: SelectBaseOfPracticeMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<SelectBaseOfPracticeMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SelectBaseOfPracticeMutation>(SelectBaseOfPracticeDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'selectBaseOfPractice',
    ...
    CanUserChoosePracticeBase(
      variables?: CanUserChoosePracticeBaseQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<CanUserChoosePracticeBaseQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CanUserChoosePracticeBaseQuery>(CanUserChoosePracticeBaseDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'CanUserChoosePracticeBase',
    ...
    GetAllPharmacies(
      variables?: GetAllPharmaciesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetAllPharmaciesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllPharmaciesQuery>(GetAllPharmaciesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetAllPharmacies',
    ...
    GetAllPharmacyIds(
      variables?: GetAllPharmacyIdsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetAllPharmacyIdsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllPharmacyIdsQuery>(GetAllPharmacyIdsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetAllPharmacyIds',
    ...
    GetAllSelectedPracticeBase(
      variables?: GetAllSelectedPracticeBaseQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetAllSelectedPracticeBaseQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllSelectedPracticeBaseQuery>(GetAllSelectedPracticeBaseDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetAllSelectedPracticeBase',
    ...
    GetAllStudents(
      variables?: GetAllStudentsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetAllStudentsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAllStudentsQuery>(GetAllStudentsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetAllStudents',
    ...
    GetCanStudentsSelectPracticeBase(
      variables?: GetCanStudentsSelectPracticeBaseQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetCanStudentsSelectPracticeBaseQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCanStudentsSelectPracticeBaseQuery>(GetCanStudentsSelectPracticeBaseDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetCanStudentsSelectPracticeBase',
    ...
    GetFullPharmacy(
      variables: GetFullPharmacyQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetFullPharmacyQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetFullPharmacyQuery>(GetFullPharmacyDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetFullPharmacy',
    ...
    GetOneStudent(
      variables?: GetOneStudentQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetOneStudentQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetOneStudentQuery>(GetOneStudentDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetOneStudent',
    ...
    GetSearchPharmacies(
      variables?: GetSearchPharmaciesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetSearchPharmaciesQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSearchPharmaciesQuery>(GetSearchPharmaciesDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetSearchPharmacies',
    ...
    GetSelectedPracticeCountById(
      variables: GetSelectedPracticeCountByIdQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<GetSelectedPracticeCountByIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSelectedPracticeCountByIdQuery>(GetSelectedPracticeCountByIdDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetSelectedPracticeCountById',
    ...
    GetSettings(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetSettingsQuery>(GetSettingsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetSettings',
